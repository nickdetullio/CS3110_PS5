...
UTIL_SOURCES = shared/hashtable.mli shared/hashtable.ml shared/util.mli shared/util.ml
...
APP_SOURCES = apps/inverted_index/inverted_index.ml \
apps/word_count/word_count.ml \
apps/game_of_life/game_of_life.ml apps/dna_sequencing/dna_sequencing.ml

LIBS = shared worker_server controller apps/inverted_index apps/word_count \
apps/game_of_life apps/dna_sequencing
...
controller.exe: shared/util.cma $(SHARED_SOURCES) $(CONTROLLER_SOURCES) controller/main.ml
	ocamlc -thread -o controller.exe -I shared -I controller -I apps/inverted_index \
	-I apps/word_count -I apps/game_of_life -I apps/dna_sequencing dynlink.cma unix.cma threads.cma str.cma util.cma \
	$(SHARED_SOURCES) $(CONTROLLER_SOURCES) controller/main.ml
